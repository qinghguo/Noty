...
struct SettingsView: View {
    ...
    @State private var shortcutTodoList: String
    ...
    init(shortcutNewNote: Binding<String>, shortcutOpenSettings: Binding<String>, shortcutToggleTopmost: Binding<String>, shortcutFoldNote: Binding<String>, shortcutTodoList: Binding<String>, shortcutColor1: Binding<String>, shortcutColor2: Binding<String>, shortcutColor3: Binding<String>, colorPreset1: Binding<Color>, colorPreset2: Binding<Color>, colorPreset3: Binding<Color>, onShortcutRecordingChange: ((Bool) -> Void)?, onClose: (() -> Void)?) {
        ...
        self._shortcutTodoList = State(initialValue: shortcutTodoList.wrappedValue)
    ...
    var shortcutSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            ShortcutRecorderRow(title: "待办圆圈", shortcut: $shortcutTodoList, onRecordingChange: onShortcutRecordingChange)
                .onChange(of: shortcutTodoList) { _, newValue in
                    let applied = applyShortcutChange(title: "待办圆圈", value: newValue) {
                        SettingsManager.shared.shortcutTodoList = newValue
                    }
                    if !applied {
                        shortcutTodoList = SettingsManager.shared.shortcutTodoList
                    }
                }
        }
        .padding()
